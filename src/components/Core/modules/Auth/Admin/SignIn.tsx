  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default w-full h-full">
      <div className="flex flex-wrap items-center h-full">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <a className="mb-5.5 inline-block" href="/">
              <Image width={40} className="" src={Logo} alt="Logo" />
            </a>

            <p className="text-lg font-semibold">
              Xin chào bạn đến với hệ thống P-CLINIC
            </p>
        ...
        <div className="w-full border-stroke xl:w-1/2 xl:border-l-2 p-[72px]">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <Form form={form} onFinish={handleSubmit}>
              <div className="mb-4">
                <label className="mb-2.5 block font-medium text-black text-lg">
                  Username
                </label>
                <div className="relative">
                  ...
                  >
                    <Input
                      ...
                      className="text-md w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none"
                    />
                  </Form.Item>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  >
                    <Input.Password
                      type="password"
                      placeholder='Chứa ít nhất 8 ký tự, chữ cái viết hoa và chữ cái viết thường'
